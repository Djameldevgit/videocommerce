// 📂 scripts/diagnoseAndRepairSolaCollection.js - VERSIÓN CORREGIDA
...
async function diagnosePostsOnly() {
  ...
  // 8. Posts por categoría (estadísticas)
  ...
  return { problemas, soluciones, stats: { total, withoutTitle: withoutTitle.length } };
}
