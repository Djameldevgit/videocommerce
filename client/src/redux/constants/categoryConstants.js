...
export const GET_CATEGORIES_WITH_VIDEOS = 'GET_CATEGORIES_WITH_VIDEOS';
export const GET_CATEGORIES_WITH_VIDEOS_SUCCESS = 'GET_CATEGORIES_WITH_VIDEOS_SUCCESS';
export const GET_CATEGORIES_WITH_VIDEOS_FAIL = 'GET_CATEGORIES_WITH_VIDEOS_FAIL';
