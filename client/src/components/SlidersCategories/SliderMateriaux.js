...
// Subcategorías de materiaux
const materiauxData = [
  { id: 'materiel_professionnel', name: 'Matériel Professionnel', emoji: '🏭', color: 'primary' },
  { id: 'outillage_professionnel', name: 'Outillage Professionnel', emoji: '🔧', color: 'success' },
  { id: 'materiaux_construction', name: 'Matériaux Construction', emoji: '🧱', color: 'danger' },
  { id: 'matieres_premieres', name: 'Matières Premières', emoji: '⚙️', color: 'warning' },
  { id: 'produits_hygiene', name: 'Produits Hygiène', emoji: '🧴', color: 'info' },
  { id: 'materiel_agricole', name: 'Matériel Agricole', emoji: '🚜', color: 'success' },
  { id: 'autre', name: 'Autre', emoji: '📦', color: 'secondary' }
];

const SliderMateriaux = () => {
  ...
  const itemsPerRow = isMobile ? 4 : 7;
  const firstRow = materiauxData.slice(0, itemsPerRow);
  ...
  return (
    <div ref={containerRef} className="materiaux-slider-container">
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{
            ...
            {isMobile ? 'Matériaux' : 'Tous les matériaux et équipements'}
          </h3>
          <p style={{
            margin: '4px 0 0 0',
            fontSize: isMobile ? '0.75rem' : '0.85rem',
            ...
            Découvrez nos catégories de matériaux professionnels
          </p>
        </div>
      ...
      <style>{`
        ...
        .materiaux-slider-container ::-webkit-scrollbar {
          display: none;
        }
        
        /* Solo efecto de press para mobile/touch */
        .materiaux-slider-container a:active div:first-child {
          transform: scale(0.95);
          transition: transform 0.1s ease;
        }
        
        /* Prevenir zoom en doble tap */
        .materiaux-slider-container * {
        ...
        @media (max-width: 380px) {
          .materiaux-slider-container a {
            width: 75px !important;
          }
          
          .materiaux-slider-container a > div:first-child {
            width: 58px !important;
            height: 58px !important;
          }
          
          .materiaux-slider-container a > div:first-child span {
            font-size: 1.8rem !important;
          }
          
          /* Botones más pequeños en pantallas muy pequeñas */
          .materiaux-slider-container button {
            width: 32px !important;
            height: 32px !important;
          }
          
          .materiaux-slider-container button svg {
        ...
        @media (hover: hover) and (pointer: fine) {
          .materiaux-slider-container a div:first-child,
          .materiaux-slider-container a span,
          .materiaux-slider-container a {
            transition: none !important;
          }
          
          .materiaux-slider-container a div:first-child:hover,
          .materiaux-slider-container a:hover {
...
export default SliderMateriaux;