...
// Subcategorías de sport
const sportData = [
  { id: 'football', name: 'Football', emoji: '⚽', color: 'success' },
  { id: 'hand_voley_basket', name: 'Hand Voley Basket', emoji: '🏀', color: 'primary' },
  { id: 'sport_combat', name: 'Sport Combat', emoji: '🥊', color: 'danger' },
  { id: 'fitness_musculation', name: 'Fitness Musculation', emoji: '💪', color: 'warning' },
  { id: 'natation', name: 'Natation', emoji: '🏊', color: 'info' },
  { id: 'velos_trotinettes', name: 'Vélos & Trotinettes', emoji: '🚲', color: 'secondary' },
  { id: 'sports_raquette', name: 'Sports Raquette', emoji: '🎾', color: 'success' },
  { id: 'sport_aquatiques', name: 'Sport Aquatiques', emoji: '🚤', color: 'info' }
];
...
const SliderSport = () => {
  ...
  const firstRow = sportData.slice(0, itemsPerRow);
  ...
  return (
    <div ref={containerRef} className="sport-slider-container">
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{
            ...
            {isMobile ? 'Sport' : 'Toutes les catégories sport'}
          </h3>
          <p style={{
            margin: '4px 0 0 0',
            fontSize: isMobile ? '0.75rem' : '0.85rem',
            ...
            Découvrez nos catégories de sport et équipements
          </p>
        </div>
        ...
        <div style={{
          ...
          >
            Voir tous les sports et équipements
      ...
      <style>{`
        ...
        .sport-slider-container a:active div:first-child {
        ...
        @media (max-width: 767px) {
          .sport-slider-container > div > div:nth-child(2)::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
          ...
          .sport-slider-container > div > div:nth-child(2)::after {
            content: '';
            position: absolute;
            top: 0;
            right: 0;
        ...
        @media (max-width: 380px) {
          .sport-slider-container a {
            width: 75px !important;
          }
          
          .sport-slider-container a > div:first-child {
            width: 58px !important;
            height: 58px !important;
          }
          
          .sport-slider-container a > div:first-child span {
            font-size: 1.8rem !important;
          }
          
          /* Botones más pequeños en pantallas muy pequeñas */
          .sport-slider-container button {
            width: 32px !important;
            height: 32px !important;
          }
          
          .sport-slider-container button svg {
        ...
        @media (hover: hover) and (pointer: fine) {
          .sport-slider-container a div:first-child,
          .sport-slider-container a span,
          .sport-slider-container a {
            transition: none !important;
          }
          
          .sport-slider-container a div:first-child:hover,
          .sport-slider-container a:hover {
        ...
        .sport-slider-container span[role="img"] {
