...
// Subcategorías de voyages
const voyagesData = [
  { id: 'voyage_organise', name: 'Voyage Organisé', emoji: '✈️', color: 'primary' },
  { id: 'location_vacances', name: 'Location Vacances', emoji: '🏠', color: 'success' },
  { id: 'hajj_omra', name: 'Hajj & Omra', emoji: '🕋', color: 'info' },
  { id: 'reservations_visa', name: 'Réservations & Visa', emoji: '🛂', color: 'warning' },
  { id: 'sejour', name: 'Séjour', emoji: '🏨', color: 'secondary' },
  { id: 'croisiere', name: 'Croisière', emoji: '🚢', color: 'info' },
...
const SliderVoyages = () => {
  ...
  const firstRow = voyagesData.slice(0, itemsPerRow);
  ...
  return (
    <div ref={containerRef} className="voyages-slider-container">
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h3 style={{
            ...
            {isMobile ? 'Voyages' : 'Toutes les offres de voyages'}
          </h3>
          <p style={{
            margin: '4px 0 0 0',
            fontSize: isMobile ? '0.75rem' : '0.85rem',
            ...
            Découvrez nos catégories de voyages et séjours
          </p>
        </div>
      ...
      <style>{`
        .voyages-slider-container ::-webkit-scrollbar { display: none; }
        .voyages-slider-container a:active div:first-child {
          transform: scale(0.95);
          transition: transform 0.1s ease;
        }
        .voyages-slider-container * {
          touch-action: manipulation;
          -webkit-tap-highlight-color: transparent;
        }
        @media (max-width: 380px) {
          .voyages-slider-container a { width: 75px !important; }
          .voyages-slider-container a > div:first-child { 
            width: 58px !important; height: 58px !important; 
          }
          .voyages-slider-container a > div:first-child span { 
            font-size: 1.8rem !important; 
          }
          .voyages-slider-container button { 
            width: 32px !important; height: 32px !important; 
          }
        }
        @media (hover: hover) and (pointer: fine) {
          .voyages-slider-container a div:first-child,
          .voyages-slider-container a span,
          .voyages-slider-container a {
