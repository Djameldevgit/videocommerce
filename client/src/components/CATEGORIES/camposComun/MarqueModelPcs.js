// 📂 components/CATEGORIES/camposComun/MarqueModelPcs.js

import React, { useState, useEffect } from 'react';
import pcsData from './json/pcs.json';

const MarqueModelPcs = ({
  postData,
  handleChangeInput,
  ...props
}) => {
  ...
  useEffect(() => {
    if (selectedMarque && pcsData) {
      const marcaEncontrada = pcsData.find((marca) => marca.marca === selectedMarque);
    ...
    <>
      ...
      <div className="mb-3">
        ...
        >
          ...
          {pcsData && pcsData.map((marca, index) => (
